...
datasets = ["PROTEINS" ]  # , "Mutagenicity",  "MCF-7",]
...
for ds in datasets:
    ...
    acc_train, std_train, acc, std = kernel_svm_evaluation(gram_matrices, classes, num_repetitions=10)  # , C=[10 ** 10])
    print(acc_train, std_train, acc, std)
    print("#")
print("###")
