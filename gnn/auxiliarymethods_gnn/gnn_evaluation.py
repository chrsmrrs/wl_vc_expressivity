...
# 10-CV for GNN training and hyperparameter selection.
def gnn_evaluation_synthetic_linear(gnn, num_nodes, layers, hidden, max_num_epochs=200, batch_size=128, start_lr=0.01, min_lr = 0.000001, factor=0.5, patience=5,
                       num_repetitions=10, all_std=True):
    ...
    dataset = synthetic_linear(path, num_nodes, transform=MyTransform()).shuffle()
...
# 10-CV for GNN training and hyperparameter selection.
def gnn_evaluation_synthetic_linear_f(gnn, num_nodes, layers, hidden, max_num_epochs=200, batch_size=128, start_lr=0.01, min_lr = 0.000001, factor=0.5, patience=5,
                       num_repetitions=10, all_std=True):
