...
def linear_test(gram_matrix, classes):

    clf = LinearSVC(C=1000, tol=0.01, max_iter=1000)
    clf.fit(gram_matrix, classes)

    val_acc = accuracy_score(classes, clf.predict(gram_matrix)) * 100.0
